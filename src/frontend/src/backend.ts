...
export class Backend implements backendInterface {
    ...
    async getStressDetectionMethods(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStressDetectionMethods();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async processFacialAnalysisResult(arg0: boolean, arg1: number): Promise<StressPrediction> {
        if (this.processError) {
            try {
                const result = await this.actor.processFacialAnalysisResult(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async processTextAnalysisResult(arg0: boolean, arg1: number): Promise<StressPrediction> {
        if (this.processError) {
            try {
                const result = await this.actor.processTextAnalysisResult(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async processVoiceAnalysisResult(arg0: boolean, arg1: number): Promise<StressPrediction> {
        if (this.processError) {
            try {
                const result = await this.actor.processVoiceAnalysisResult(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
